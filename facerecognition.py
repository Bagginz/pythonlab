...
#โหลดภาพ ให้ระบบจำ
person1_image = face_recognition.load_image_file("images/bew.jpg")
person1_face_encoding = face_recognition.face_encodings(person1_image)[0]

person2_image = face_recognition.load_image_file("images/bell.jpg")
person2_face_encoding = face_recognition.face_encodings(person1_image)[0]
